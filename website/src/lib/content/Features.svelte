...
<section id="features" class="website-container">
  <div class="grid-container">
    <FeatureCard small eyebrow="Built to last" title="Made in Rust with a custom architecture" extraClass="col-span-3">
    ...
    <FeatureCard
      ...
      description="No Hacker News account required: hncli does not need nor store your credentials in any way whatsoever."
...
<style lang="postcss">
  ...
  .link {
    @apply font-semibold text-hncli-dark-red underline hover:text-gray-50;
  }
</style>
